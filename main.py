...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        variables1 = {
            "Q_ft_VVST": "коэффициент фактического значения обобщенных, наиболее значимых показателей вида ВВСТ",
            "Q_mr_VVST": "коэффициент обобщенных требуемых показателей ТТХ"
        }
        ...
        variables2 = {
            "N_VVST": "количество образцов группы ВВСТ, имеющихся в наличии",
            "N_VVST_shtat": "потребное количество образцов группы ВВСТ на год"
        }
        ...
        variables3 = {
            "N_isp_VVST": "количество исправных образцов группы ВВСТ",
            "N_VVST_shtat": "потребное количество образцов группы ВВСТ на год"
        }
        ...
        variables4 = {
            "N_sovr_VVST": "количество современных образцов группы ВВСТ",
            "N_VVST_shtat": "потребное количество образцов группы ВВСТ на год"
        }
        ...
        variables6 = {
            "N_isp_VVST": "количество исправных образцов группы ВВСТ",
            "N_VVST": "общее количество образцов группы ВВСТ"
        }
